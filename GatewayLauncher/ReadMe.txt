========================================================================
    Win32 アプリケーション: GatewayLauncher プロジェクトの概要
========================================================================

この GatewayLauncher アプリケーションは、AppWizard により作成されました。

このファイルには、GatewayLauncher 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


GatewayLauncher.vcxproj
...
GatewayLauncher.vcxproj.filters
...
GatewayLauncher.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル GatewayLauncher.rc 
    にインクルードされます。

GatewayLauncher.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル GatewayLauncher.rc 
    にインクルードされます。
